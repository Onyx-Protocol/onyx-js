...
export interface OnyxInstance {
  _networkPromise: Promise<ProviderNetwork>;
}

export interface OnyxOptions {
  privateKey?: string;
  mnemonic?: string;
...
export interface OTokenServiceRequest {
  addresses?: string[] | string;
  block_number?: number;
  block_timestamp?: number;
  meta?: boolean;
...
export type APIRequest = AccountServiceRequest |
  OTokenServiceRequest | MarketHistoryServiceRequest | GovernanceServiceRequest;
