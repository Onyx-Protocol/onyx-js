/**
 * @file Utility
 * @desc These methods are helpers for the Onyx class.
 */
 ...
 *     contracts used by the Onyx Protocol.
 *
 ...
 * @example
 * ```
 * console.log('oETH Address: ', Onyx.util.getAddress(Onyx.oETH));
 * ```
 */
 ...
 * @example
 * ```
 * console.log('oETH ABI: ', Onyx.util.getAbi('oEther'));
 * ```
 */
