...
intro += '# Onyx.js\n\n';
intro += '## Introduction\n\n';
intro += '[Onyx.js](https://github.com/Onyx-Protocol/onyx-js) is a ';
intro += 'JavaScript SDK for Ethereum and the Onyx Protocol. It wraps ';
...
intro += ' message in the Development channel of the Onyx Discord.\n\n';
intro += '</section>\n\n';
